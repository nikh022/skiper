...
const AnimatedPlaceholder = ({ showSearch }: { showSearch: boolean }) => (
  <AnimatePresence mode="wait">
    <motion.p
      ...
      className="pointer-events-none w-[150px] text-sm absolute text-black/70"
    >
          ...
          <div className="h-12 bg-black/5 dark:bg-white/5 rounded-b-xl">
            <div className="absolute left-3 bottom-3 flex items-center gap-2">
              ...
              >
                ...
                <Paperclip
                  className={cn(
                    "w-4 h-4 text-black/40 hover:text-black transition-colors",
              ...
              <button
                ...
                className={cn(
                  ...
                  value
                    ...
                    : "bg-black/5 dark:bg-white/5 text-black/40 hover:text-black"
                )}
              >
